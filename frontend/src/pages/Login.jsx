    ...
    const handleFormSubmition = (e) => {
        ...
        try {
            ...
            axios.post('http://localhost:3300/login', {
                ...
                .catch((error) => {
                    setMessage(error.response.data.message); // Handle error
                });
        } catch (error) {
            console.log(error)
            setMessage(error)
            ...
            <div className="flex h-screen w-full">
                ...
                <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
                    <div className="max-w-md w-full p-6">
                        ...
                        <h1 className="text-sm font-semibold mb-6 text-gray-500 text-center">Login to Our Community with all time access and free </h1>
                        <h1 className="text-xs font-semibold mb-6 text-red-500 text-center">
                            {message && message}
                        </h1>
                        ...
                        <div className="mt-4 text-sm text-gray-600 text-center">
                            <p>Do not have an account? <Link to="/userAuth/register" className="text-black hover:underline">Sign Up here</Link>
                            </p>
                        </div>
                    </div>
                </div>
